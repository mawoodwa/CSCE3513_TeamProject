...
class Menu_AddPlayerName(tk.Frame):
    ...
    def openMenu(self, tuplePlayerAtArrow):
        self.tkraise()
        self.entryPlayerFirstName["state"]="normal"
        self.entryPlayerFirstName.insert(0,tuplePlayerAtArrow[0])
        self.entryPlayerFirstName.focus_set()
        self.entryPlayerLastName["state"]="normal"
        self.entryPlayerLastName.insert(0,tuplePlayerAtArrow[1])
